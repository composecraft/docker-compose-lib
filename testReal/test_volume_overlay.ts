import { Binding, Compose, Image, PortMapping, Service, Translator, Volume } from "../lib/cjs/";
...
const vol = new Volume({name: "test"})
compose.addBinding(new Binding({source: vol, target:"/lala"}),[service])
